...
SPORTING_DIRECTOR_PROMPT = """You are the sporting director of the club, tasked with looking at players market values and the clubs budget. You then 
 return affordable (bool), reasoning, suggested_structure."""
...
gathered by the other team members to make your reccommendation."""